...
const createQuestion = function (questionObj) {
  ...
  let questionContainer = document.createElement("h1");
  questionContainer.setAttribute("id", "question");
  questionContainer.innerText = questionObj.question; //cambio l'innertext del container con la stringa relativa alla domanda
